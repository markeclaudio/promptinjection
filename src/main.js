const translations = {
  en: {
    ...
    note_title: "Note:",
    note_text: "<b>We don't need your files!</b> To protect your privacy, this tool is designed to work only on your computer. Nothing is ever sent over the internet",
    tab_inject: "Inject",
    tab_verify: "Verify",
    step_1: "1. Upload PDF",
  ...
  it: {
    ...
    note_title: "Nota:",
    note_text: "Il prompt verrà inserito nel campo \"Oggetto\" dei metadati del PDF. Molti lettori PDF e sistemi AI leggono questo campo come descrizione principale.",
    tab_inject: "Inietta",
    tab_verify: "Verifica",
    step_1: "1. Carica PDF",
